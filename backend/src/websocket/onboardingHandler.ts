...
export async function handleAuthFlow(ws: AuthenticatedWebSocket, message: any) {
  if (message.type !== "message" || !message.content) {
    ws.send(
      JSON.stringify({ type: "error", message: "Please send a text message." })
    );
    return;
  }
  ...
  switch (step) {
    ...
    case "ASK_INTERESTS":
      ...
      if (isValid) {
        ...
        responseMessage = "Please provide at least one learning interest.";
      }
      break;
    ...
    case "ASK_GOALS":
      ...
      if (isValid) {
        ...
        responseMessage =
          "Please provide a more detailed description of your goals (at least 10 characters).";
      }
      break;
    ...
    case "ASK_EDUCATION":
      ...
      if (isValid) {
        ...
        responseMessage =
          "Please provide more details about your background (at least 10 characters).";
      }
      break;
  }
